...
const StatusMessage = styled.div<{isSuccessful: boolean}>`
  margin-left: 1rem;
  font-size: 1rem;
  color: ${({isSuccessful, theme}) => isSuccessful ? theme.colors.accentGreen : theme.colors.redAccent}
`
            ...
            footer={
                <BasicCardFooter>
                    ...
                    <StatusMessage isSuccessful={formState.isSubmitSuccessful}>
                        {
                            showFormState ? formState.isSubmitSuccessful ? `✔ Success` : "✘ Error. Try Again" : ""
                        }
                    </StatusMessage>
                </BasicCardFooter>
            }
